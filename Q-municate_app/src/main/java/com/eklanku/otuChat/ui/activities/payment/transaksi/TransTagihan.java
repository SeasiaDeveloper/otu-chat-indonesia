            ...
            public void onResponse(Call<LoadDataResponse> call, Response<LoadDataResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (status.equals("SUCCESS")) {
                        ...
                        utilsAlert.globalDialog(TransTagihan.this, titleAlert, error);
                        //Toast.makeText(getBaseContext(), "Terjadi kesalahan:\n" + error, Toast.LENGTH_SHORT).show();
                    }
                } else {
                    utilsAlert.globalDialog(TransTagihan.this, titleAlert, getResources().getString(R.string.error_api));
...
//            Toast.makeText(this, "Masukkan minimal 8 digit nomor", Toast.LENGTH_SHORT).show();
    ...
    private void cek_transaksi() {
        ...
        Log.d("OPPO-1", "cek_transaksi - transtagihan: "+PreferenceUtil.getNumberPhone(this)));
        Call<TransBeliResponse> transBeliCall = mApiInterface.postTransBeli(PreferenceUtil.getNumberPhone(this)), load_id, nominal, txtNo.getText().toString(), "pascabyr");
