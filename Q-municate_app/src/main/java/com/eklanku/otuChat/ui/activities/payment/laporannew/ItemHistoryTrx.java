...
public class ItemHistoryTrx {
    ...
    public String tgl_sukses;
    public String product_kode;
    ...
    public String subscribersegmentation;
    public String powerconsumingcategory;
    public String swreferencenumber;
    public String billercode;
    public String noref1;
    public String noref2;
    public String customerphonenumber;
    public String lastpaidperiode;
    ...
    public String odinstallmentamount;
    public String odpenaltyfee;
    public String billeradminfee;
    public String itemmerktype;
    public String minimumpayamount;
    public String miscfee;
    public String branchname;
    public String infoteks;
    public String serviceunitphone;
    public String serviceunit;
    public String tarif_daya;
    public String wording;
    public String bl_th;
    public String angsuran_ke;
    public String angsuran_pokok;
    public String jumlah_tagihan;
