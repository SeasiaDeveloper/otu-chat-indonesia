...
public class SpinnerAdapterPPOB extends BaseAdapter {
    Context context;
    private ArrayList<String> nama, price, ep;
    LayoutInflater inflter;
    List<DataProduct> products;

    public SpinnerAdapterPPOB(Context applicationContext, List<DataProduct> products) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        text_nominal.setVisibility(View.GONE);
