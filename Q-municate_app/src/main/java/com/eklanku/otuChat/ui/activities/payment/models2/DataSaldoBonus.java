...
public class DataSaldoBonus {
    ...
    public List<DataDetailSaldoBonus> getBalance() {
        return Balance;
    }

    public void setBalance(List<DataDetailSaldoBonus> balance) {
        Balance = balance;
    }

    @SerializedName("Balance")
    private List<DataDetailSaldoBonus> Balance;
