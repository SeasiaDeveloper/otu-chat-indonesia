...
public class QBFindUsersCommand extends ServiceCommand {
    ...
    public static void start(Context context, ConnectycubeUser currentUser, String constraint, int page) {
    ...
    public Bundle perform(Bundle extras) throws Exception {
        ...
        ConnectycubeUser currentUser = (ConnectycubeUser) extras.getSerializable(QBServiceConsts.EXTRA_USER);
        ...
        Collection<ConnectycubeUser> userList = ConnectycubeUsers.getUsersByFullName(constraint, requestBuilder, requestParams).perform();
